...
// Composite buffer type used by graph split mode.  Each split tensor is
// backed by the corresponding child buffer type (normally an RPC buffer,
// with the CPU buffer allowed for the host split).
